...
first_names = [
		"John", "Alice", "Michael", "Emily", "David",
		"Sarah", "Daniel", "Olivia", "William", "Sophia",
		"Matthew", "Emma", "Christopher", "Ava", "James",
		"Lily", "Joseph", "Mia", "Robert", "Grace"
]

last_names = [
		"Smith", "Johnson", "Brown", "Davis", "Miller",
		"Wilson", "Anderson", "Martinez", "Jones", "Taylor",
		"Clark", "Lee", "Walker", "Hall", "Garcia",
...
def calculator(first_names, last_names, crimes_sentences):
	...
	print(f'the defendant, {first_names[first_name]} {last_names[last_name]} has been found guilty of: ')
	actual_sentence = 0
	...
	if user_guess == actual_sentence:
		...
		print(f'you got it within 100 years so uh pretty dog water, it was {actual_sentence}')
	else:
